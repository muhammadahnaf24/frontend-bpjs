...
const listLaporanBPJS = computed(() => laporanStore.listData);
...
// ================= COMPUTED LOGIC (FILTER & SORT) =================

const filteredAndSortedList = computed(() => {
  const sourceData = listLaporanBPJS.value || [];
...
const totalT5 = computed(() => {
  const data = listLaporanBPJS.value || [];
  return data.filter((item) => item.task5).length;
});
  ...
  <div>
    <div class="space-y-6">
      ...
      >
          ...
          <div class="grid grid-cols-1 md:grid-cols-5 gap-4 items-end">
            ...
            <div>
              ...
              >
                <option value="all">Semua</option>
                <option
                  class="text-green-600 font-bold bg-green-50"
                  value="ada"
                >
                  ADA
                </option>
        ...
        <div
          v-if="message"
          class="bg-yellow-50 p-4 text-center text-yellow-700"
        >
          {{ message }}
        </div>
                ...
                <td class="px-4 py-3 align-top">
                  ...
                  >
                    <div
                      ...
                      :class="
                        item['task' + n] ? 'bg-green-500' : 'bg-slate-200'
                      "
                      :title="
                        'Task ' +
                        n +
